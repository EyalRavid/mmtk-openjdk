...
// Must match mmtk-core's util::constants::LOG_MIN_OBJECT_SIZE, or every RC read below
// addresses the wrong table entry.
...
inline uint16_t mmtk_get_rc(void* o) {
    return mmtk_get_rc_8bits(o); //was mmtk_get_rc_2bits(o)
}
